(() => {
    ...
    const input1 = document.querySelector('#task3_select_1')
    const input2 = document.querySelector('#task3_select_2')
    const input3 = document.querySelector('#task3_select_3')
